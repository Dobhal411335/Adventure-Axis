                ...
                <NavigationMenu.List className="flex xl:space-x-1">
                    {menuItems.map((item, index) => (
                        <NavigationMenu.Item key={index} className="relative flex justify-start w-full max-w-7xl">
                          <NavigationMenu.Trigger className="flex items-center whitespace-nowrap px-2 py-2 justify-center md:text-xs xl:text-sm font-semibold hover:bg-blue-500 data-[state=open]:bg-blue-300 data-[state=open]:text-black rounded-md">
                                {item.title}
                    ...
                    {allMenuItems.length > 0 && allMenuItems.map((cat, index) => (
                        <NavigationMenu.Item key={index} className="relative flex justify-end">
                                    <NavigationMenu.Trigger className="flex items-center whitespace-nowrap px-2 py-2 justify-center md:text-xs xl:text-sm font-semibold hover:bg-blue-500 data-[state=open]:bg-blue-300 data-[state=open]:text-black rounded-md xl:text-nowrap">
                                        {cat.catTitle}
                                    </NavigationMenu.Trigger>
                                    <AnimatePresence>
                                        <NavigationMenu.Content asChild>
